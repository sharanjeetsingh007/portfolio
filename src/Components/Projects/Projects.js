                        ...
                        >
                            ...
                            >
                                <AccordionSummary
                                    ...
                                    id="panel1a-header"
                                >
                                    <Typography component={'span'}><h4> <b>Blogr</b></h4></Typography>
                                </AccordionSummary>
                                <AccordionDetails
                                    onClick={e => e.stopPropagation()}
                                >
                                    <Typography>
                                        The project is based on the Frontend Mentor challenge for creating the website with the responisve desing.

                                        Tech stack - HTML 5, SCC 3, SCSS, JavaScript

                                    </Typography>
                                    <Button className='demo' variant="contained"
                                        style={{ width: "18%", marginTop: "15px", padding: "4px" }}
                                        href="https://beamish-longma-4b288f.netlify.app/"
                                        target="_blank"
                                    >D<span style={{ textTransform: "lowercase" }}>emo</span></Button>
                                </AccordionDetails>
                            </Accordion>
                            ...
                            >
                                <AccordionSummary
                                    ...
                                    id="panel1a-header"
                                >
                                    <Typography component={'span'}><h4> <b>Easy Bank</b></h4></Typography>
                                </AccordionSummary>
                                <AccordionDetails
                                    onClick={e => e.stopPropagation()}
                                >
                                    ...
                                    <Button className='demo' variant="contained"
                                        style={{ width: "18%", marginTop: "15px", padding: "4px" }}
                                        href="https://stupendous-toffee-55df7a.netlify.app/"
                                        target="_blank"
                                    >D<span style={{ textTransform: "lowercase" }}>emo</span></Button>
                                </AccordionDetails>
                            </Accordion>
                            ...
                            >
                                <AccordionSummary
                                    ...
                                    id="panel1a-header"
                                >
                                    <Typography component={'span'}><h4> <b>BuildCon</b></h4></Typography>
                                </AccordionSummary>
                                <AccordionDetails
                                    onClick={e => e.stopPropagation()}
                                >
                                    <Typography>
                                        The project is based on the CSS frqamework Bootstrap with the Grid system to make the Ui resoponsive.
                                    </Typography>
                                    <Button className='demo' variant="contained"
                                        style={{ width: "18%", marginTop: "15px", padding: "4px" }}
                                        href="https://melodic-lebkuchen-b4f3e4.netlify.app/"
                                        target="_blank"
                                    >D<span style={{ textTransform: "lowercase" }}>emo</span></Button>
                                </AccordionDetails>
                            </Accordion>
